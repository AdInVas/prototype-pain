...
public class BloodThinnerItem extends MedicalVial implements ISimpleMedicalUsable, IAllowInMedicbags {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("item.prototype_pain.blood_thinner.discription").withStyle(ChatFormatting.GRAY));
    ...
    public void setupDefaults(ItemStack stack) {
        addFluid(stack,100, MedicalFluids.STREPTOKINASE);
    }
}
