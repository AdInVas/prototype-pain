...
public class MorphineVialItem extends MedicalVial implements IAllowInMedicbags {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("item.prototype_pain.morphine_vial.discription").withStyle(ChatFormatting.GRAY));
