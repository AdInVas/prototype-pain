...
public class BrainGrowItem extends MedicalVial implements IAllowInMedicbags {
    public BrainGrowItem() {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("item.prototype_pain.brain_grow.discription").withStyle(ChatFormatting.GRAY));
        appendFluidListText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
    }

    @Override
    public void setupDefaults(ItemStack stack) {
        addFluid(stack,50, MedicalFluids.BRAINGROW);
    }
