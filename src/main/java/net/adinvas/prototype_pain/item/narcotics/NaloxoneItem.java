...
public class NaloxoneItem extends Item implements INarcoticUsable {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("item.prototype_pain.naloxone.discription").withStyle(ChatFormatting.GRAY));
    }
}
