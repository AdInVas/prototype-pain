...
public class Keybinds {
    ...
    public static KeyMapping OPEN_FLUID_SCREEN = new KeyMapping("key.prototype_pain.fluid_screen",InputConstants.Type.KEYSYM,GLFW.GLFW_KEY_RIGHT_BRACKET,"key.categories.prototype_pain");


    public static void register(RegisterKeyMappingsEvent event){
        event.register(OPEN_PAIN_GUI);
        event.register(GIVE_UP);
        event.register(OPEN_FLUID_SCREEN);
    }
