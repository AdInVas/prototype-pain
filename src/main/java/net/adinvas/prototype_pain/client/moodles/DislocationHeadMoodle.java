...
public class DislocationHeadMoodle extends AbstractMoodleVisual{
    ...
    public ResourceLocation renderIcon(GuiGraphics ms, float partialTicks, int x, int y) {
        ResourceLocation tex = new ResourceLocation(PrototypePain.MOD_ID,"textures/gui/moodles/mouth_dislocated_moodle.png");
    ...
    public List<Component> getTooltip(Player player) {
        ...
        componentList.add(Component.translatable("prototype_pain.gui.moodle.dislocation_head.title3").withStyle(ChatFormatting.GOLD));
        componentList.add(Component.translatable("prototype_pain.gui.moodle.dislocation_head.description3").withStyle(ChatFormatting.GRAY));
