...
public class DislocationMoodle extends AbstractMoodleVisual{
    ...
    public ResourceLocation renderIcon(GuiGraphics ms, float partialTicks, int x, int y) {
        ResourceLocation tex = new ResourceLocation(PrototypePain.MOD_ID,"textures/gui/moodles/dislocation_moodle.png");
    ...
    public List<Component> getTooltip(Player player) {
        ...
        componentList.add(Component.translatable("prototype_pain.gui.moodle.dislocation.title3").withStyle(ChatFormatting.GOLD));
        componentList.add(Component.translatable("prototype_pain.gui.moodle.dislocation.description3").withStyle(ChatFormatting.GRAY));
