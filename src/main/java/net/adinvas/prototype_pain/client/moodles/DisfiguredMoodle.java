...
public class DisfiguredMoodle extends AbstractMoodleVisual{
    ...
    public ResourceLocation renderIcon(GuiGraphics ms, float partialTicks, int x, int y) {
        ResourceLocation tex = new ResourceLocation(PrototypePain.MOD_ID,"textures/gui/moodles/mouth_gone_moodle.png");
    ...
    public List<Component> getTooltip(Player player) {
        ...
        componentList.add(Component.translatable("prototype_pain.gui.moodle.mouth_gone.title2").withStyle(ChatFormatting.YELLOW));
        componentList.add(Component.translatable("prototype_pain.gui.moodle.mouth_gone.description2").withStyle(ChatFormatting.GRAY));
