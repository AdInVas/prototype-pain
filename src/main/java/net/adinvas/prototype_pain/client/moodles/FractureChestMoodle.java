...
public class FractureChestMoodle extends AbstractMoodleVisual{
    ...
    public List<Component> getTooltip(Player player) {
        ...
        componentList.add(Component.translatable("prototype_pain.gui.moodle.fracture_chest.title3").withStyle(ChatFormatting.GOLD));
        componentList.add(Component.translatable("prototype_pain.gui.moodle.fracture_chest.description3").withStyle(ChatFormatting.GRAY));
